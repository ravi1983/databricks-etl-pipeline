...
This folder defines all source code for the 'Ecommerce ETL' pipeline:
...
* Take a look at the sample under "sample_users_ecommerce_etl.py" to get familiar with the syntax.
