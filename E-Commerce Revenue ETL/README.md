# E-Commerce Revenue ETL

This folder defines all source code for the 'E-Commerce Revenue ETL' pipeline:
...
* Take a look at the sample under "sample_users_e_commerce_revenue_etl.py" to get familiar with the syntax.
